            ...
            public void run() {
                try{
                    ...
                    while(true) {
                        ...
                        int readByteCount = is.read(byte);
                        String message = new String(bytes, 0, readByteCount, "UTF-8");
                        */

                        // 데이터 받기
                        DataInputStream dis = new DataInputStream(socket.getInputStream()); // 문자열을 받기위해서 DataInputStream(보조 스트림)에 바로 연결
                        ...
                        dos.writeUTF(msg);
                        dos.flush();
                        System.out.println("서버가 받은 데이터를 다시 보냄 : "+msg);
                        // ----------------------------------------------------------------
